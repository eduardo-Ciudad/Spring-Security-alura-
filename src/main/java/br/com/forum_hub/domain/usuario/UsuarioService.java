...
public class UsuarioService implements UserDetailsService {
    ...
    public UsuarioService(UsuarioRepository usuarioRepository, PasswordEncoder encoder, PasswordEncoder passwordEncoder, EmailService emailService, PerfilRepository perfilRepository){
